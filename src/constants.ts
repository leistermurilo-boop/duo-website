...
export const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      "Importação via OCR",
      "OCR ilimitado",
      { name: "Radar B2G™", description: "Monitora o mercado de contratações públicas no seu segmento e envia newsletter semanal personalizada com oportunidades e indicadores relevantes." },
      { name: "Newsletter Semanal", description: "Resumo semanal com indicadores econômicos, alertas de mercado B2G e oportunidades relevantes." },
      "APIs IBGE e BACEN",
      { name: "Cruzamento Macroeconômico", description: "Cruza IPCA, INPC e dados do IBGE com seus contratos para antecipar o impacto da inflação na sua margem." },
      { name: "Tax Regime Engine — Reforma Tributária", description: "Calcula o impacto dos novos impostos em cada contrato e gera dossiê financeiro com variação de margem documentada." },
